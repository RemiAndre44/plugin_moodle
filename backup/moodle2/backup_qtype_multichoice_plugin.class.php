 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_qtype_multichoice_advance_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $plugin = $this->get_plugin_element(null, '../../qtype', 'multichoice_advance');
        ...
        $multichoice_advance->set_source_table('qtype_multichoice_advance',
