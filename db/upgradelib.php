...
/**
 * Upgrade library code for the multichoice_advance question type.
 *
 * @package    qtype
...
/**
 * Class for converting attempt data for multichoice_advance questions when upgrading
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoice_advance_qe2_attempt_updater extends question_qtype_attempt_updater {
    protected $order;

    public function is_blank_answer($state) {
        // Blank multichoice_advance answers are not empty strings, they rather end in a colon.
